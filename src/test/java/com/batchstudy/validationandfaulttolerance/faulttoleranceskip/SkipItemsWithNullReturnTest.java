package com.batchstudy.validationandfaulttolerance.faulttoleranceskip;
...
@SpringBootTest(classes = SkipItemsWithNullReturnTest.TestConfig.class)
public class SkipItemsWithNullReturnTest {
    @Autowired
